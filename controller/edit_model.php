...
<head>
  ...
  <script type="text/javascript">
    function update_model() {
      ...
      var image = document.getElementById('f_img').value;
      var guid = document.getElementById('model_id').value;
      if(name && kat_id) {
        var params = 'name='+name+'&kat_id='+kat_id+'&guid='+guid+'&image='+image;
        do_ajax('update_model',params,'','','post',0,0);
...
<table width="100%" cellpadding="0" cellspacing="0" align="left" class="cart_table" style="border: 1px solid #1d5987;">
      ...
      <table border="0" width="100%" cellpadding="0" cellspacing="0" align="left">
        <tr>
          ...
          <td align="left" valign="middle">
            <input type="text" id="name" size="40px" value="<?=$model['name']?>">
        ...
        <tr>
          <td colspan="2" align="left" valign="middle">
            ...
            <input type="text" id="f_img" value="<?=$model['image']?>" size="40"/><br/>
            <style type="text/css">
  ...
  <th height="50px" align="left" valign="middle" style="background: #1d5987;">
    <input type="button" value="Сохранить изменения" onclick="update_model();">
  </th>
</table>
</body>
</html>